...
public class SavedLocationsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        List<SavedLocation> locations = db.savedLocationDao()
                .getLocationsForUser(username);
        ...
        if (locations.isEmpty()) {
            ...
            adapter[0] = new SavedLocationAdapter(locations, location -> {
                ...
                List<SavedLocation> updated = db.savedLocationDao()
                        .getLocationsForUser(currentUsername);
